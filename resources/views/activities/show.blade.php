...
<div class="relative">
    ...
    <div class="absolute inset-0 flex flex-col justify-end p-8">
        <nav class="absolute top-4 left-4 flex items-center space-x-2 text-lg px-3 py-1 rounded">
            ...
            <!-- Kegiatan link -->
            <a href="{{ route('activities.activity') }}" class="text-white hover:text-gray-700">Kegiatan</a>
            <!-- Separator -->
            <span class="text-white">›</span>
            <!-- Detail -->
        ...
        <a href="{{ route('activities.edit', $activity->id) }}" class="absolute top-4 right-4 bg-red-600 text-white px-4 py-2 rounded flex items-center space-x-2">
