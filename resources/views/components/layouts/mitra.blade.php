...
<nav class="bg-white py-4 px-8 shadow-md flex justify-between items-center">
    <div class="flex items-center">
        <!-- Logo dan Teks -->
        <a href="/mitra/dashboard" wire:navigate><img src="{{ asset('cirebonLogo.png') }}" alt="Logo" class="h-10 mr-4 ml-32"></a>
    </div>
    <!-- Menu Navigasi -->
...
<footer class="bottom-0 left-0 w-full bg-gray-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div>
            <a href="/mitra/dashboard" class="border border-white text-white py-2 px-4 rounded hover:bg-white hover:text-gray-900 transition duration-300">
